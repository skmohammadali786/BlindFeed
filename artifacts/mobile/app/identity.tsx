...
function makeStyles(colors: ReturnType<typeof useTheme>["colors"]) {
  return StyleSheet.create({
    ...
    idLabel: { fontSize: 14, fontFamily: "JetBrainsMono_400Regular", color: colors.textSecondary },
    idValue: {
      fontSize: 22,
    ...
    resetText: { fontSize: 14, fontFamily: "JetBrainsMono_400Regular", color: colors.textSecondary },
    copyBtn: {
      flexDirection: "row",
      alignItems: "center",
      gap: 8,
    ...
    copyBtnText: { fontSize: 15, fontFamily: "JetBrainsMono_600SemiBold", color: colors.textSecondary },
    footerText: {
      fontSize: 13,
