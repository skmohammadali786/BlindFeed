...
function makeStyles(colors: ReturnType<typeof useTheme>["colors"]) {
  return StyleSheet.create({
    ...
    section: { fontSize: 17, fontFamily: "Inter_600SemiBold", color: colors.text, marginTop: 8 },
    ...
    dataItem: { fontSize: 14, fontFamily: "Inter_400Regular", color: colors.text },
    dataKept: { fontSize: 12, fontFamily: "Inter_400Regular", color: colors.textTertiary },
    ...
    badgeText: { fontSize: 14, fontFamily: "Inter_500Medium", color: colors.green },
  });
}
