...
export default function UsageInsightsScreen() {
  ...
  useEffect(() => {
    api.get<ApiMyPost[]>("/posts/mine").then((data) => {
      setAllPosts(data);
      ...
      <View style={[styles.container, { paddingTop: top }]}>
        ...
        >
          ...
          <AnimatedListItem index={1}>
            <View style={[styles.streakCard, streak >= 3 && styles.streakCardActive]}>
              ...
              <View style={styles.streakBadge}>
                <Text style={[styles.streakNum, streak >= 3 && { color: streak >= 7 ? "#FFD60A" : colors.green }]}>
                  {streak}
                </Text>
          ...
          <View style={styles.privacyNote}>
            ...
            <Text style={styles.privacyText}>Stats are based on your activity. Streak counts consecutive days with at least one post.</Text>
          </View>
        </ScrollView>
      </View>
    </ScreenTransition>
