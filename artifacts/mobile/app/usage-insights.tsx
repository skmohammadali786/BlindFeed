...
function makeStyles(colors: ReturnType<typeof useTheme>["colors"]) {
  return StyleSheet.create({
    ...
    sectionTitle: { fontSize: 22, fontFamily: "JetBrainsMono_700Bold", color: colors.text, marginBottom: 2 },
    overallPct: { fontSize: 13, fontFamily: "JetBrainsMono_400Regular", color: colors.textSecondary },

    statsRow: { flexDirection: "row", gap: 10 },
    statCard: { flex: 1, backgroundColor: colors.surface, borderRadius: 14, padding: 16, alignItems: "center", gap: 6 },
    statValue: { fontSize: 26, fontFamily: "JetBrainsMono_700Bold", color: colors.text },
    statLabel: { fontSize: 11, fontFamily: "JetBrainsMono_500Medium", color: colors.textTertiary, textAlign: "center" },
    ...
    streakLabel: { fontSize: 15, fontFamily: "JetBrainsMono_600SemiBold", color: colors.text },
    streakSub: { fontSize: 12, fontFamily: "JetBrainsMono_400Regular", color: colors.textSecondary, marginTop: 2 },
    streakBadge: { alignItems: "center" },
    streakNum: { fontSize: 28, fontFamily: "JetBrainsMono_700Bold", color: colors.textSecondary },
    streakUnit: { fontSize: 11, fontFamily: "JetBrainsMono_500Medium", color: colors.textTertiary },

    card: { backgroundColor: colors.surface, borderRadius: 14, padding: 16, gap: 12 },
    cardTitle: { fontSize: 15, fontFamily: "JetBrainsMono_600SemiBold", color: colors.textSecondary },
    ...
    reactionCount: { fontSize: 20, fontFamily: "JetBrainsMono_700Bold", color: colors.text },
    reactionLabel: { fontSize: 13, fontFamily: "JetBrainsMono_400Regular", color: colors.textSecondary },
    ...
    progressLabel: { fontSize: 12, fontFamily: "JetBrainsMono_400Regular", color: colors.textTertiary },
    ...
    postStatContent: { fontSize: 15, fontFamily: "JetBrainsMono_500Medium", color: colors.text, lineHeight: 22 },
    ...
    statChipText: { fontSize: 13, fontFamily: "JetBrainsMono_600SemiBold" },
    statChipPct: { fontSize: 14, fontFamily: "JetBrainsMono_700Bold" },
    statChipLabel: { fontSize: 11, fontFamily: "JetBrainsMono_400Regular" },
    ...
    postStatVoteLabel: { fontSize: 12, fontFamily: "JetBrainsMono_400Regular", color: colors.textTertiary },
    postStatNoVotes: { fontSize: 12, fontFamily: "JetBrainsMono_400Regular", color: colors.textTertiary, fontStyle: "italic" },

    emptyState: { alignItems: "center", paddingTop: 60, gap: 12 },
    emptyTitle: { fontSize: 18, fontFamily: "JetBrainsMono_600SemiBold", color: colors.textSecondary },
    emptySub: { fontSize: 14, fontFamily: "JetBrainsMono_400Regular", color: colors.textTertiary, textAlign: "center", lineHeight: 21, paddingHorizontal: 20 },
    postBtn: { marginTop: 8, backgroundColor: colors.green, borderRadius: 14, paddingHorizontal: 28, paddingVertical: 14 },
    postBtnText: { fontSize: 15, fontFamily: "JetBrainsMono_600SemiBold", color: "#000" },
    privacyNote: { flexDirection: "row", alignItems: "flex-start", gap: 8, paddingTop: 8 },
    privacyText: { flex: 1, fontSize: 12, fontFamily: "JetBrainsMono_400Regular", color: colors.textTertiary, lineHeight: 18 },
  });
}
